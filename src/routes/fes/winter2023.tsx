...
const Winter2022: Component<{}> = () => {
  ...
  return (
    <div class="mt-16">
      ...
      <Meta
        property="og:image"
        content="https://fes.vcborn.com/img/fes/winter2023.png"
      />
      ...
      <div class="relative flex flex-col justify-center h-[80vh] bg-black text-white">
        <div class="max-w-7xl mx-auto px-4 container font-train text-6xl md:text-8xl relative group">
          <div class="bg-black relative pb-6 pl-4 z-10 duration-300 group-hover:-translate-x-1 group-hover:translate-y-1">
            <p>VCFes Winter 2023</p>
            <p>@2024/1/8</p>
          </div>
          <div class="bg-green-500 absolute top-8 -bottom-4 left-0 right-8 z-0 duration-300 group-hover:translate-x-1 group-hover:-translate-y-1"></div>
        </div>
        ...
        <div class="bg-black text-white py-16 pr-4 pl-8">
          ...
          <div class="my-10 flex flex-col gap-6 items-start justify-center font-futura">
            <div class="flex items-center gap-5 text-2xl md:text-4xl">
              ...
              <div>
                <p>mushroom</p>
                <p class="text-lg md:text-2xl font-sans opacity-80 mt-2">
                  紹介文をここに入力。
                </p>
              </div>
            </div>
        ...
        <div class="pr-4 pl-8 py-16">
          <h2 class="text-5xl font-semibold font-futura flex flex-wrap items-center">
            ...
            <a
              ...
              class="text-youtube flex items-center gap-3"
            >
